...
public class Player extends Entity {
	...
	private int statusBarHeight = (int) (60 * Game.SCALE);
	...
	private void initAttackBox() {
		attackBox = new Rectangle2D.Float(x, y, (int) (35 * Game.SCALE), (int) (50 * Game.SCALE));
	}
	...
	private void loadAnimations() {
		...
		for(int j = 0; j < animations.length; j++)
			for(int i = 0; i < animations[j].length; i++)
				animations[j][i] = img.getSubimage(i*120, j*120, 120, 120);		
